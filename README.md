...
Stratos Metrics provides a Helm chart for deploying Prometheus and the Cloud Foundry Firhose exporterro Kubernetes.

> **Note: This is in-development and by no means ready for production.**

It deploys both of these components and fronts the Prometheus server with an nginx server to provide authenticated access to Prometheus.
